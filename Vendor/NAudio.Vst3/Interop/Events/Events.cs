...
/// union of variant payloads. The union slot is exposed as a 24-byte opaque buffer; typed
...
/// </para>
/// <para>
/// 24 bytes match the Windows x64 VST3 ABI: the complete <c>Event</c> must occupy 48 bytes.
/// The largest SDK variant (<c>NoteExpressionTextEvent</c>) occupies 24 bytes and
/// <see cref="NoteOnEvent"/> occupies 20 bytes.
/// </para>
/// </remarks>
[StructLayout(LayoutKind.Sequential)]
internal unsafe struct Event
{
    ...
    /// </summary>
    public fixed byte UnionData[24];
}
